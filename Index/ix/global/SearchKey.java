 ...
 * The search key includes a type, size and value.
 */
public class SearchKey implements Comparable<SearchKey> {
   ...
   * Assumes the type is stored first as a byte, then the
   * size as a short, then the value.
   */
   ...
   * Writes the type first as a byte, then the
   * size as a short, then the value.
   */
   ...
   * including the type, size and value.
   */
